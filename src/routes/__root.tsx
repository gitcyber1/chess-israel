...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "שח-מט ישראל" },
      { name: "description", content: "שחמט בעברית מול המחשב, שלוש רמות קושי כולל רמת קספרוב, עם אפשרות לבטל מהלכים ולתרגל — חינם בדפדפן." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "שח-מט ישראל" },
      { property: "og:description", content: "שחמט בעברית מול המחשב, שלוש רמות קושי, אפשרות לבטל מהלכים ולתרגל — חינם בדפדפן." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://chess-israel.lovable.app/" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "שח-מט ישראל" },
      { name: "twitter:description", content: "שחמט בעברית מול המחשב, שלוש רמות קושי, אפשרות לבטל מהלכים ולתרגל — חינם בדפדפן." },
